...
const BecomeAHost = () => {
  ...
  return (
    <>
      <Button onClick={() => setIsOpen(true)} color="info" variant="contained">
        Become a host
      </Button>
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-lg w-full max-w-lg shadow-xl cursor-default relative overflow-hidden"
          >
