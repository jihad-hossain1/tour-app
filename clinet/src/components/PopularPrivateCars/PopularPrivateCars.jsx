                ...
                {popularPrivateTours.map((tourSpot, index) => (<Card key={index} sx={{ maxWidth: 345 }}>
                    <CardActionArea>
                        <CardMedia
                            component="img"
                            height="140"
                            image="https://img.freepik.com/free-photo/view-car-running-high-speed-city_23-2150635434.jpg?t=st=1705467372~exp=1705470972~hmac=e959c0365439be36fab4fb76f8ce8b2f9b5f35899547e05ea5280bc10c8779d1&w=740"
                            alt="green iguana"
                        />
                        <CardContent>
