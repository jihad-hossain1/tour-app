...
const addClient = {
  ...
  resolve: async (parent, { name, phone, email, password, image }) => {
...
const deleteClientWithAdminEnsure2 = async (parent, { id, confirmation }, context) => {
...
module.exports = { deleteClient, addClient, loginClient,updateClientPassword,clientPasswordReset };
